...
### Setting up a dev environment for the Sumrachat website application

===========================

Much of the functionality in Sumrachat is actually in the `matrix-react-sdk` and
`matrix-js-sdk` modules. It is possible to set these up in a way that makes it
easy to track the `develop` branches in git and to make local changes without
having to manually rebuild each time.
...
```bash
git clone https://github.com/Volodymyrquo/matrix-js-sdk.git
pushd matrix-js-sdk
yarn link
yarn install
popd
...
```bash
git clone https://github.com/Volodymyrquo/matrix-react-sdk.git
pushd matrix-react-sdk
yarn link
yarn link matrix-js-sdk
yarn install
...
```bash
git clone https://github.com/Volodymyrquo/element-web.git
cd element-web
yarn link matrix-js-sdk
yarn link matrix-react-sdk
yarn install
