            ...
            return httpBackend
                ...
                .then(() => {
                    ...
                    httpBackend
                        ...
                        .respond(200, { chunk: [] });
                    httpBackend
                        .when("GET", "/thirdparty/protocols")
                        .respond(200, {});
                    return httpBackend.flushAllExpected();
                })
                .then(() => {
                    console.log(
                        `${Date.now()} App made requests for directory view; switching to a room.`
                    );
                ...
                .then(() => {
                    ...
                    httpBackend
                        .when("POST", "/join/" + encodeURIComponent(ROOM_ALIAS))
                        .respond(200, { room_id: ROOM_ID });
                })
                .then(() => {
                ...
                .then(() => {
                    ...
                    return httpBackend.flush(
                        "/join/" + encodeURIComponent(ROOM_ALIAS)
                    );
                })
                .then(() => {
